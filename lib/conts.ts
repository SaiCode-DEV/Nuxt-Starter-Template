...
export const SECTION_TYPES: SectionType[] = [
  { id: SECTION_TYPE_RIVER_SECTION, name: 'River Section', needsOverpass: true },
  { id: SECTION_TYPE_SLALOM_SECTION, name: 'Slalom Section', needsOverpass: true },
  { id: SECTION_TYPE_FREESTYLE_SPOT, name: 'Freestyle Spot', needsOverpass: false },
